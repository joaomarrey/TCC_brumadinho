---
title: "brumadinho_synthetic_control_va_serv"
...
ggplot() +
  ...
  scale_y_continuous(
    breaks = seq(0, max(plot_df$Treated, plot_df$Synthetic), by = 10000),
...
```{r}
placebo_df_filtered_va_serv = placebo_df_filtered
gap_data_va_serv = gap_data
rmspe_stats_filtered_va_serv = rmspe_stats_filtered
treated_ratio_va_serv = treated_ratio
```


```{r}
placebo_df_filtered = placebo_df_filtered_va_serv
gap_data = gap_data_va_serv
rmspe_stats_filtered = rmspe_stats_filtered_va_serv
treated_ratio = treated_ratio_va_serv
