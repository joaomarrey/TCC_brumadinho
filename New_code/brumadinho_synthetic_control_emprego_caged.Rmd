---
title: "brumadinho_synthetic_control_emprego"
...
```{r}
placebo_df_filtered_emp = placebo_df_filtered
gap_data_emp = gap_data
rmspe_stats_filtered_emp = rmspe_stats_filtered
treated_ratio_emp = treated_ratio
```


```{r}
placebo_df_filtered = placebo_df_filtered_emp
gap_data = gap_data_emp
rmspe_stats_filtered = rmspe_stats_filtered_emp
treated_ratio = treated_ratio_emp
