...
matching_pivot.to_csv(os.path.join(matching_data_path, 'matching_pivot_emprego.csv'))
matching_pivot_standard.to_csv(os.path.join(matching_data_path, 'matching_pivot_standard_emprego.csv'))
matched.to_csv(os.path.join(matching_data_path, 'matched_distance_emprego.csv'), index=False)
k_nearest.to_csv(os.path.join(matching_data_path, 'matching_k_nearest_emprego.csv'), index=False)

matched_no_downstream.to_csv(os.path.join(matching_data_path, 'matched_distance_no_downstream_emprego.csv'), index=False)
k_nearest_no_downstream.to_csv(os.path.join(matching_data_path, 'matching_k_nearest_no_downstream_emprego.csv'), index=False)