...
matching_pivot.to_csv(os.path.join(matching_data_path, 'matching_pivot_remuneracao.csv'))
matching_pivot_standard.to_csv(os.path.join(matching_data_path, 'matching_pivot_standard_remuneracao.csv'))
matched.to_csv(os.path.join(matching_data_path, 'matched_distance_remuneracao.csv'), index=False)
k_nearest.to_csv(os.path.join(matching_data_path, 'matching_k_nearest_remuneracao.csv'), index=False)

matched_no_downstream.to_csv(os.path.join(matching_data_path, 'matched_distance_no_downstream_remuneracao.csv'), index=False)
k_nearest_no_downstream.to_csv(os.path.join(matching_data_path, 'matching_k_nearest_no_downstream_remuneracao.csv'), index=False)
