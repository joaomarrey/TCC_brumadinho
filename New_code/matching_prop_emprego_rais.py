...
matched_no_downstream.to_csv(os.path.join(matching_data_path, 'matched_distance_no_downstream_prop_pop_emprego_rais.csv'), index=False)
k_nearest_no_downstream.to_csv(os.path.join(matching_data_path, 'matching_k_nearest_no_downstream_prop_pop_emprego_rais.csv'), index=False)