---
title: "brumadinho_synthetic_control_va_adm"
...
#matched_control_group = read.csv(file.path(matching_data_path, 'matching_k_nearest_va_adm_per_capita.csv'))
...
ggplot() +
  ...
  scale_y_continuous(
    breaks = seq(0, max(plot_df$Treated, plot_df$Synthetic), by = 2500),
...
```{r}
placebo_df_filtered_va_adm = placebo_df_filtered
gap_data_va_adm = gap_data
rmspe_stats_filtered_va_adm = rmspe_stats_filtered
treated_ratio_va_adm = treated_ratio
```


```{r}
placebo_df_filtered = placebo_df_filtered_va_adm
gap_data = gap_data_va_adm
rmspe_stats_filtered = rmspe_stats_filtered_va_adm
treated_ratio = treated_ratio_va_adm
