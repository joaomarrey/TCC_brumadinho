...
for va in list_va:
    ...
    matching_pivot.to_csv(os.path.join(matching_data_path, f'matching_pivot_{va.lower()}.csv'))
    matching_pivot_standard.to_csv(os.path.join(matching_data_path, f'matching_pivot_standard_{va.lower()}.csv'))
    matched.to_csv(os.path.join(matching_data_path, f'matched_distance_{va.lower()}.csv'), index=False)
    k_nearest.to_csv(os.path.join(matching_data_path, f'matching_k_nearest_{va.lower()}.csv'), index=False)

    matched_no_downstream.to_csv(os.path.join(matching_data_path, f'matched_distance_no_downstream_{va.lower()}.csv'), index=False)
    k_nearest_no_downstream.to_csv(os.path.join(matching_data_path, f'matching_k_nearest_no_downstream_{va.lower()}.csv'), index=False)
