...
special_predictors = list(
    list("VA_AGRO_PER_CAPITA", 2002, "mean"),
    list("VA_AGRO_PER_CAPITA", 2003, "mean"),
    list("VA_AGRO_PER_CAPITA", 2004, "mean"),
    list("VA_AGRO_PER_CAPITA", 2005, "mean"),
    list("VA_AGRO_PER_CAPITA", 2006, "mean"),
    list("VA_AGRO_PER_CAPITA", 2007, "mean"),
    list("VA_AGRO_PER_CAPITA", 2008, "mean"),
    list("VA_AGRO_PER_CAPITA", 2009, "mean"),
    list("VA_AGRO_PER_CAPITA", 2010, "mean"),
    list("VA_AGRO_PER_CAPITA", 2011, "mean"),
    list("VA_AGRO_PER_CAPITA", 2012, "mean"),
    list("VA_AGRO_PER_CAPITA", 2013, "mean"),
    list("VA_AGRO_PER_CAPITA", 2014, "mean"),
    list("VA_AGRO_PER_CAPITA", 2015, "mean"),
    list("VA_AGRO_PER_CAPITA", 2016, "mean"),
    list("VA_AGRO_PER_CAPITA", 2017, "mean"),
    list("VA_AGRO_PER_CAPITA", 2018, "mean")
...
ggplot() +
  ...
  labs(
    ...
    x = "Year",
    y = "Agriculture GVA Per Capita (R$)"
  ) +
  theme(
...
sp <- ggplot(gap_data, aes(x = Coefficient, y = Gap, color = Group)) +
  ...
  labs(
    ...
    x = "Year",
    y = "Gap in Agriculture GVA Per Capita (R$)"
  ) +
  scale_y_continuous(
    labels = label_number(big.mark = ".", decimal.mark = ",", prefix = "R$ ")
  ) +
  ...
  theme(text = element_text(size = 10),
        ...
        panel.grid.minor.y = element_line(color = "gray95", size = 0.3),
        legend.position = "bottom") +
  annotate("text", x = "tr2019", y = max(gap_data$Gap), label = "Treatment Year", hjust = 1.1)+
...
sp <- ggplot() +
  ...
  geom_vline(xintercept = 2019, linetype = "dotted", color = "black", size = 1) +
  annotate("text", x = 2019, y = max(gap_data$Gap),
...
```{r}
special_predictors = list(
    list("VA_IND_PER_CAPITA", 2002, "mean"),
    list("VA_IND_PER_CAPITA", 2003, "mean"),
    list("VA_IND_PER_CAPITA", 2004, "mean"),
    list("VA_IND_PER_CAPITA", 2005, "mean"),
    list("VA_IND_PER_CAPITA", 2006, "mean"),
    list("VA_IND_PER_CAPITA", 2007, "mean"),
    list("VA_IND_PER_CAPITA", 2008, "mean"),
    list("VA_IND_PER_CAPITA", 2009, "mean"),
    list("VA_IND_PER_CAPITA", 2010, "mean"),
    list("VA_IND_PER_CAPITA", 2011, "mean"),
    list("VA_IND_PER_CAPITA", 2012, "mean"),
    list("VA_IND_PER_CAPITA", 2013, "mean"),
    list("VA_IND_PER_CAPITA", 2014, "mean"),
    list("VA_IND_PER_CAPITA", 2015, "mean"),
    list("VA_IND_PER_CAPITA", 2016, "mean"),
    list("VA_IND_PER_CAPITA", 2017, "mean"),
    list("VA_IND_PER_CAPITA", 2018, "mean")
...
sp <- ggplot() +
  ...
  labs(
    ...
    subtitle = "Placebo tests in gray; treated unit in color",
    x = "Year",
    y = "Gap in Industry GVA Per Capita (R$)"
  ) +
  theme_minimal() +
  theme(
    text = element_text(size = 10),
...
```{r}
special_predictors = list(
    list("VA_SERV_PER_CAPITA", 2002, "mean"),
    list("VA_SERV_PER_CAPITA", 2003, "mean"),
    list("VA_SERV_PER_CAPITA", 2004, "mean"),
    list("VA_SERV_PER_CAPITA", 2005, "mean"),
    list("VA_SERV_PER_CAPITA", 2006, "mean"),
    list("VA_SERV_PER_CAPITA", 2007, "mean"),
    list("VA_SERV_PER_CAPITA", 2008, "mean"),
    list("VA_SERV_PER_CAPITA", 2009, "mean"),
    list("VA_SERV_PER_CAPITA", 2010, "mean"),
    list("VA_SERV_PER_CAPITA", 2011, "mean"),
    list("VA_SERV_PER_CAPITA", 2012, "mean"),
    list("VA_SERV_PER_CAPITA", 2013, "mean"),
    list("VA_SERV_PER_CAPITA", 2014, "mean"),
    list("VA_SERV_PER_CAPITA", 2015, "mean"),
    list("VA_SERV_PER_CAPITA", 2016, "mean"),
    list("VA_SERV_PER_CAPITA", 2017, "mean"),
    list("VA_SERV_PER_CAPITA", 2018, "mean")
...
sp <- ggplot(gap_data, aes(x = Coefficient, y = Gap, color = Group)) +
  ...
  labs(
    title = "Gap between Treated Unit and Synthetic Control",
    x = "Year",
    y = "Gap in Services GVA Per Capita (R$)"
  ) +
  scale_y_continuous(
    labels = label_number(big.mark = ".", decimal.mark = ",", prefix = "R$ ")
  ) +
...
```{r}
special_predictors = list(
    list("VA_ADM_PER_CAPITA", 2002, "mean"),
    list("VA_ADM_PER_CAPITA", 2003, "mean"),
    list("VA_ADM_PER_CAPITA", 2004, "mean"),
    list("VA_ADM_PER_CAPITA", 2005, "mean"),
    list("VA_ADM_PER_CAPITA", 2006, "mean"),
    list("VA_ADM_PER_CAPITA", 2007, "mean"),
    list("VA_ADM_PER_CAPITA", 2008, "mean"),
    list("VA_ADM_PER_CAPITA", 2009, "mean"),
    list("VA_ADM_PER_CAPITA", 2010, "mean"),
    list("VA_ADM_PER_CAPITA", 2011, "mean"),
    list("VA_ADM_PER_CAPITA", 2012, "mean"),
    list("VA_ADM_PER_CAPITA", 2013, "mean"),
    list("VA_ADM_PER_CAPITA", 2014, "mean"),
    list("VA_ADM_PER_CAPITA", 2015, "mean"),
    list("VA_ADM_PER_CAPITA", 2016, "mean"),
    list("VA_ADM_PER_CAPITA", 2017, "mean"),
    list("VA_ADM_PER_CAPITA", 2018, "mean")
...
ggplot() +
  ...
  labs(
    title = "Treated Unit vs Synthetic Control",
    x = "Year",
    y = "Public Admin GVA Per Capita (R$)"
  ) +
  theme(
    text = element_text(size = 10),
    plot.title = element_text(hjust = 0.5),
...
sp <- ggplot(gap_data, aes(x = Coefficient, y = Gap, color = Group)) +
  ...
  labs(
    title = "Gap between Treated Unit and Synthetic Control",
    x = "Year",
    y = "Gap in Public Admin GVA Per Capita (R$)"
  ) +
  scale_y_continuous(
    labels = label_number(big.mark = ".", decimal.mark = ",", prefix = "R$ ")
  ) +
