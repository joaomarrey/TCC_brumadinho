---
title: "brumadinho_synthetic_control_va_agro"
...
ggplot() +
  ...
  scale_y_continuous(
    breaks = seq(0, max(plot_df$Treated, plot_df$Synthetic), by = 250),
  ...
  annotate("text", x = 2019, y = min(plot_df$Treated, plot_df$Synthetic),
...
```{r}
placebo_df_filtered_va_agro = placebo_df_filtered
gap_data_va_agro = gap_data
rmspe_stats_filtered_va_agro = rmspe_stats_filtered
treated_ratio_va_agro = treated_ratio
```


```{r}
placebo_df_filtered = placebo_df_filtered_va_agro
gap_data = gap_data_va_agro
rmspe_stats_filtered = rmspe_stats_filtered_va_agro
treated_ratio = treated_ratio_va_agro
