...
# with downstream
matched = pd.read_csv(os.path.join(matching_data_path, 'matching_k_nearest_prop_pop_emprego_rais.csv'))
...
# plt.show()
plt.tight_layout()
plt.savefig('Mapas_matching/prop_pop_emprego_rais_municipios_map.png', dpi=500, bbox_inches='tight')
# plt.savefig("prop_pop_emprego_rais_vectorized.pdf")

#merged.to_file('SHPS_matching/prop_pop_emprego_rais_municipios_shape.shp')


# no downstream
matched = pd.read_csv(os.path.join(matching_data_path, 'matching_k_nearest_no_downstream_prop_pop_emprego_rais.csv'))
merged = gpd.read_file(os.path.join(maps_data, 'MG_Municipios_2023.shp'))
...
# plt.show()
plt.tight_layout()
plt.savefig('Mapas_matching/prop_pop_emprego_rais_municipios_map_no_dowsntream.png', dpi=500, bbox_inches='tight')
# plt.savefig("prop_pop_emprego_rais_vectorized.pdf")

#merged.to_file('SHPS_matching/prop_pop_emprego_rais_municipios_shapeno_dowsntream.shp')
